...
const AdminSignup = () => {
  ...
  const handleSignup = (e) => {
    ...
    const success = registerAdmin(email, password);
    if (success) {
    ...
    <div className="flex justify-center items-center min-h-screen bg-[#F3F4F6]">
      <div className="border p-8 rounded-lg shadow-sm w-full max-w-md bg-white border-[#E5E7EB]">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-[#111827]">Admin Signup</h1>
          <p className="text-sm text-[#6B7280]">Create your admin account</p>
        </div>
